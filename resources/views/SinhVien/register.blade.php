    ...
    <div class="register-container">
        <div class="register-card w-100">
            ...
            <div class="register-form-section">
                <div class="register-title text-center mb-3">Đăng Ký</div>
                <a href="#" class="btn btn-google w-100 mb-2"><i class="fab fa-google me-2"></i>Đăng ký bằng Google</a>
                ...
                <form>
                    ...
                    <div class="text-center mt-3" style="font-size:1.08rem; color:#6C3FC5; font-family: 'Inter', Arial, Helvetica, sans-serif;">
                        Đã có tài khoản? <a href="/login" style="color:#9333EA; font-weight:600; text-decoration:none;">Đăng nhập</a>
                    </div>
