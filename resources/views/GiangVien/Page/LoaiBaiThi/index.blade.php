...
<script>
    new Vue({
        ...
        methods: {
            ...
            saveData() {
                let url = this.formData.id ? '/giang-vien/loai-bai-thi/update' : '/giang-vien/loai-bai-thi/create';
            ...
            deleteData() {
                axios.post('/giang-vien/loai-bai-thi/delete', this.formData)
                    .then((res) => {
                        NotifiSuccess(res, () => {
                            this.loadData();
            ...
            changeStatus(data) {
                axios.post('/giang-vien/loai-bai-thi/change-status', data)
                    .then((res) => {
                        NotifiSuccess(res, () => {
                            this.loadData();
                        });
