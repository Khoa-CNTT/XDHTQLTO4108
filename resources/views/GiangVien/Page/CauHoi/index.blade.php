...
new Vue({
    ...
    methods: {
        ...
        saveData() {
            ...
            axios.post('/giang-vien/cau-hoi/create', payload)
                .then((res) => {
                    NotifiSuccess(res, () => {
                        this.loadData();
        ...
        loadDataMonHoc() {
            axios.get('/giang-vien/mon-hoc/data')
                .then((res) => {
        ...
        loadData() {
            axios.get('/giang-vien/cau-hoi/data')
                .then((res) => {
        ...
        deleteCauHoi(cauhoi) {
            axios.post('/giang-vien/cau-hoi/delete', {id: cauhoi.id})
                .then((res) => {
                    NotifiSuccess(res, () => {
                        this.loadData();
                    });
        ...
        getDapAnCauHoi(id_cau_hoi) {
            axios.post('/giang-vien/cau-hoi/dap-an', {id_cau_hoi: id_cau_hoi})
                .then((res) => {
        ...
        updateData() {
            ...
            axios.post('/giang-vien/cau-hoi/update', payload)
                .then((res) => {
                    NotifiSuccess(res, () => {
                        this.loadData();
